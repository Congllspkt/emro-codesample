...
<html>
	<head>
		...
		Map<String, String> moduleMap = new HashMap() {{
            ...
            //put("ep-eform-sign-mail", "ui/bp/eform/popup/ep-eform-sign-mail.html");
            //put("em-test-menu", "ui/bp/eform/test/em-test-menu.html");
            put("em-eform-sign-mail", "ui/common/eform/em-eform-sign-mail.html");
		}};
		...
		while(paramNames.hasMoreElements()){
			...
			Object requestObj = request.getAttribute(paramName);

			if(String.class.equals(requestObj.getClass())) {
                queryParamMap.put(paramName, (String) requestObj);
            }
		}
