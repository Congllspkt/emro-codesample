...
/**
 * 협력사관리그룹 등록 요청 결재관련 처리하는 서비스 Class입니다.
 *
 * @author yjpark
 * @FileName vendorVmgRegistrationApprovalService.java
 * @package smartsuite.app.bp.vendorMaster.vendorInfo.approval
 * @Since 2023. 07. 31
 * @변경이력 : [2023. 07. 31] yjpark 최초작성
 */
@Service
@Transactional
@SuppressWarnings("unchecked")
public class VendorVmgRegistrationApprovalService implements ApprovalStrategy {
	...
	public void doApprove(String approvalType, String appId) {
		...
		vendorMasterService.updateVendorRegistrationInfoByApprovedApproval(param);
	}
