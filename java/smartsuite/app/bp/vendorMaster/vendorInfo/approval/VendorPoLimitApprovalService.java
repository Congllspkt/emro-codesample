...
/**
 * 협력사 발주 제한 요청 결재관련 처리하는 서비스 Class입니다.
 *
 * @author yjpark
 * @FileName VendorPoLimitApprovalService.java
 * @package smartsuite.app.bp.vendorMaster.vendorInfo.approval
 * @Since 2023. 08. 23
 * @변경이력 : [2023. 08. 23] yjpark 최초작성
 */
@Service
@Transactional
@SuppressWarnings("unchecked")
public class VendorPoLimitApprovalService implements ApprovalStrategy {
	...
	public void doApprove(String approvalType, String appId) {
		...
		vendorMasterService.updateVendorPoLimitByApprovedApproval(param);
	}
