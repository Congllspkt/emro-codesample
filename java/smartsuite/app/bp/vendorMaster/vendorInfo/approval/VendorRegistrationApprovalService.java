...
/**
 * 발주 협력사 등록 요청 결재관련 처리하는 서비스 Class입니다.
 *
 * @author Sykim
 * @FileName VendorRegistrationApprovalService.java
 * @package smartsuite.app.bp.vendorMaster.vendorInfo.approval
 * @Since 2023. 06. 27
 * @변경이력 : [2023. 06. 27] Sykim 최초작성
 */
@Service
@Transactional
@SuppressWarnings("unchecked")
public class VendorRegistrationApprovalService implements ApprovalStrategy {
