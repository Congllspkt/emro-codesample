...
/**
 * 주요 정보 변경 요청 결재관련 처리하는 서비스 Class입니다.
 *
 * @author yjpark
 * @FileName VendorInfoModifyApprovalService.java
 * @package smartsuite.app.bp.vendorMaster.vendorInfo.approval
 * @Since 2023. 07. 27
 * @변경이력 : [2023. 07. 27] yjpark 최초작성
 */
@Service
@Transactional
@SuppressWarnings("unchecked")
public class VendorInfoModifyApprovalService implements ApprovalStrategy {
	...
	public void doApprove(String approvalType, String appId) {
		...
		vendorMasterService.updateVendorInfoModifyByApprovedApproval(param);
	}
