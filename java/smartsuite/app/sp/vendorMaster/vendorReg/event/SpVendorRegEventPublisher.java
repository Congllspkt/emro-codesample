package smartsuite.app.sp.vendorMaster.vendorReg.event;
...
@Service
public class SpVendorRegEventPublisher {
	@Inject
	 ...
	 * @return ResultMap
	 */
	public ResultMap saveSpOnboardingEvalFulfillment(Map param) {
		CustomSpringEvent event = CustomSpringEvent.toCompleteEvent("saveSpOnboardingEvalFulfillment", param);
		applicationEventPublisher.publishEvent(event);
		return (ResultMap) event.getResult();
	}
}
