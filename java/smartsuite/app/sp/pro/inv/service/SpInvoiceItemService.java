...
import smartsuite.app.sp.pro.inv.repository.SpInvoiceItemRepository;
...
@Service
@Transactional
public class SpInvoiceItemService {
	@Inject
	private SpInvoiceItemRepository invoiceItemRepository;
