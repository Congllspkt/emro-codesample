package smartsuite.app.sp.pro.inv.service;
...
import smartsuite.app.sp.pro.inv.validator.SpInvoiceValidator;
...
@Service
@Transactional
public class SpInvoiceService {
	
	@Inject
	private SharedService sharedService;
	
	@Inject
	private SpInvoiceValidator invoiceValidator;
	
	@Inject
	private ProStatusService proStatusProcessor;
	
	@Inject
	private SpInvoiceItemService invoiceItemService;
	 ...
	 * @return
	 */
	public ResultMap requestApprovalInvoice(Map<String, Object> param) {
		Map<String, Object> invoiceData = (Map<String, Object>) param.get("invoiceData");
		...
		if(ResultMap.STATUS.SUCCESS.equals(resultMap.getResultStatus())) {
			...
			if(ResultMap.STATUS.SUCCESS.equals(resultMap.getResultStatus())) {
				...
				proStatusProcessor.requestInvoice(resultData);
			}
		}
		return resultMap;
	}
